<template>
    <div>
        <PageTitle title="设备类型"></PageTitle>
        <div class="pageWrapper">
            <div class="lookWrapper" v-show="!edit">
                <div class="searchWrapper">
                    ...
                    <el-button type="primary" size="medium" class="addBtn" icon="el-icon-plus" @click="add" v-if="hasPermission('admin/protype', 'add')">添加</el-button>
                </div>
                <el-table
                        ref="table"
                        :data="tableData"
                    ...
                    <el-table-column label="操作" width="150" v-if="hasPermission('admin/protype', 'update')">
                        <template slot-scope="scope">
                            <el-button
                                    size="mini"
                                    type="primary"
                                    v-if="hasPermission('admin/protype', 'update')"
    ...
    export default {
        ...
        methods:{
            ...
            submitForm(formName) {
                ...
                this.$refs[formName].validate((valid) => {
                    if (valid) {
                        checkToken(function () {
                            that.loading = true;
                            that.axios.post('/maintenance/ptstore', {
                                id: that.activeId,
            ...
            lists(){
                ...
                checkToken(function () {
                    that.loading = true;
                    that.axios.get('/maintenance/ptype', {
                        params: { //请求参数
            ...
            batchDelete(){
                ...
                that.$confirm('此操作将删除该信息, 是否继续?', '提示', {
                    ...
                    checkToken(function () {
                        ...
                        that.axios.post('/maintenance/ptbatchelete', {
                            idstring: idstring,
